...
class Iiwa14DynamicKDL(Iiwa14DynamicBase):
    def __init__(self, tf_suffix='kdl'):
        ...
        self.kine_chain = self.kine_tree.getChain(
            "iiwa_link_0", "iiwa_link_ee")
        ...
        self.dyn_solver = PyKDL.ChainDynParam(
            self.kine_chain, PyKDL.Vector(0, 0, -9.8))
